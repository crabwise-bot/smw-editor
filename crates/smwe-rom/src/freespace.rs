//! Free-space scanning for repointing ROM data (level layer/sprite data, GFX
//! files, message boxes, overworld layer 2, ...).
//!
//! Previously duplicated near-verbatim in `level_editor` and `world_editor`;
//! consolidated here so every write path that needs to repoint something
//! behaves the same.
